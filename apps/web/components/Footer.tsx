  ...
  return (
    <footer className="bg-gray-950 border-t border-gray-800 text-gray-400">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        {/* Top Section: Brand & Compact Links */}
        <div className="flex flex-col md:flex-row justify-between items-start gap-8">
          
          {/* Left: Brand Identity */}
          <div className="flex flex-col max-w-sm">
            <Link href="/" className="text-xl font-extrabold tracking-tight text-green-500 hover:text-green-400 transition-colors">
          ...
          <div className="flex gap-12 sm:gap-16">
            <div className="flex flex-col space-y-3 text-sm">
              ...
              <Link href="/feed" className="hover:text-green-400 transition-colors">Live Feed</Link>
              <Link href="/wall" className="hover:text-green-400 transition-colors">Celebration Wall</Link>
            ...
            <div className="flex flex-col space-y-3 text-sm">
              ...
              <Link href="#" className="hover:text-green-400 transition-colors">Guidelines</Link>
            </div>
          </div>
        </div>
